...
class ClientResolver
{
    ...
    private static $defaultArgs = [
        'service' => [
            'type'     => 'value',
            'valid'    => ['string'],
            'doc'      => 'Name of the service to utilize. This value will be supplied by default when using one of the SDK clients (e.g., Api\\S3\\S3Client).',
            'required' => true,
            'internal' => true
        ],
        'modelsDir' => [
        ...
        'exception_class' => [
            ...
            'default'  => 'Api\Exception\ApiException',
            'internal' => true
        ],
        'scheme' => [
            'type'     => 'value',
        ...
        'endpoint_provider' => [
            ...
            'doc'      => 'An optional PHP callable that accepts a hash of options including a "service" and "region" key and returns NULL or a hash of endpoint data, of which the "endpoint" key is required. See Api\\Endpoint\\EndpointProvider for a list of built-in providers.',
        ...
        'handler' => [
            'type'     => 'value',
            'valid'    => ['callable'],
            'doc'      => 'A handler that accepts a command object, request object and returns a promise that is fulfilled with an Api\ResultInterface object or rejected with an Api\Exception\ApiException. A handler does not accept a next handler as it is terminal and expected to fulfill a command. If no handler is provided, a default Guzzle handler will be utilized.',
     ...
     * @see Api\Client::__construct for a list of available options.
     */
    ...
    public static function _apply_user_agent($value, array &$args, HandlerList $list)
    {
        ...
        array_unshift($value, 'generic-api-php/' . Sdk::VERSION);
