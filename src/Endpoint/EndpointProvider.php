...
use Api\Exception\UnresolvedEndpointException;
 ...
 * will throw an {@see Api\Exception\UnresolvedEndpointException}.
 *
 ...
 * {@see Api\or_chain}. This function accepts providers as arguments and
...
class EndpointProvider
{
     ...
     * @return callable
     */
    public static function defaultProvider($modelsDir)
    {
        $data = \Api\load_compiled_json($modelsDir . '/endpoints.json');
