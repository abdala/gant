 ...
 * Api\ResultInterface and Api\Exception\ApiException objects.
 */
class MockHandler implements \Countable
{
    ...
    /**
     * The passed in value must be an array of {@see Api\ResultInterface} or
     * {@see ApiException} objects that acts as a queue of results or
    ...
    /**
     * Adds one or more variadic ResultInterface or ApiException objects to the
     * queue.
     */
    public function append()
    {
        foreach (func_get_args() as $value) {
            if ($value instanceof ResultInterface
                ...
                throw new \InvalidArgumentException('Expected an Api\ResultInterface or Api\Exception\ApiException.');
            }
        }
    }
