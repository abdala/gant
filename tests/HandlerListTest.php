...
class HandlerListTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCanPrintStack()
    {
        ...
        $this->assertEquals("1) Step: init, Name: bar, Function: callable(['Api\\Test\\HandlerListTest', 'bar'])", $lines[1]);
        $this->assertEquals('2) Step: validate, Function: callable(Api\Test\HandlerListTest::foo)', $lines[2]);
        $this->assertEquals("3) Step: sign, Name: baz, Function: callable(['Api\\Middleware', 'tap'])", $lines[3]);
